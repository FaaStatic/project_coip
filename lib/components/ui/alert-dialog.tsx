...
import {buttonTextVariants, buttonVariants} from '@untr/apps-coip/lib/components/ui/button';
import * as AlertDialogPrimitive from '@untr/apps-coip/lib/components/primitives/alert-dialog';
