...
import { Calendar } from '@untr/apps-coip/lib/components/deprecated-ui/calendar';
import { Combobox, ComboboxOption } from '@untr/apps-coip/lib/components/deprecated-ui/combobox';
import { Button, buttonTextVariants } from '@untr/apps-coip/lib/components/ui/button';
import { Checkbox } from '@untr/apps-coip/lib/components/ui/checkbox';
import { Input } from '@untr/apps-coip/lib/components/ui/input';
import { Label } from '@untr/apps-coip/lib/components/ui/label';
import { RadioGroup } from '@untr/apps-coip/lib/components/ui/radio-group';
import { type Option, Select } from '@untr/apps-coip/lib/components/ui/select';
import { Switch } from '@untr/apps-coip/lib/components/ui/switch';
import { Textarea } from '@untr/apps-coip/lib/components/ui/textarea';
import { Calendar as CalendarIcon } from '@untr/apps-coip/lib/icons/Calendar';
