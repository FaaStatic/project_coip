...
import {Image as RNImage, ImageErrorEventData, ImageLoadEventData, NativeSyntheticEvent, View,} from 'react-native';
import * as Slot from '@untr/apps-coip/lib/components/primitives/slot';
import {ComponentPropsWithAsChild, SlottableViewProps, ViewRef} from '@untr/apps-coip/lib/components/primitives/types';
