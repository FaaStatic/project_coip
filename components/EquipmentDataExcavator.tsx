...
const EquipmentDataExcavator = ({
  ...
  const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isSuccess, refetch, isFetching } =
    useGetAllEquipmentExcavator(search);
                  ...
                  onChange={(value) => {
                    ...
                    setTimeout(() => {
                      queryClient.resetQueries({
                        queryKey: ['getEquipmentExa', search],
                        exact: true,
                      });
                      refetch();
                    }, 500);
...
export default EquipmentDataExcavator;
